import Border from "@/components/email-editor/right-sidebar/hero-attributes/border";
import Dimension from "@/components/email-editor/right-sidebar/hero-attributes/dimension";
import Setting from "@/components/email-editor/right-sidebar/hero-attributes/settings";
